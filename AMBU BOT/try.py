...
from bs4 import BeautifulSoups, BeautifulSoup
...
while True:
	...
	url = "https://www.justdial.com/%s/24-Hours-Ambulance-Services/nct-10000352/page-%s" % (location, page_number)
